const dataHTML = [
  ...
  },
  {
    ...
    answer:
      "Семантична розмітка - підхід до створення HTML-розмітки ґрунтується на використанні тегів за їх призначенням відповідно до специфікації і які відповідають типу контенту, що розмічується.Тобто семантична розмітка означає, що теги не вибираються на підставі того, як вони відображаються в браузері - вони вибираються на підставі типу та структури контенту, який розмічується. Наприклад - <h1> <header> <nav> <main> <img> <p> <a><footer> ",
  },
  {
